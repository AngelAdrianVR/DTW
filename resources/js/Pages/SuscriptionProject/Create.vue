...
export default {
  ...
  methods: {
    store() {
      this.form.post(route("suscription-projects.store"), {
        onSuccess: () => {
          this.$notify({
            title: "Correcto",
            message: "Se ha agregado un nuevo proyecto de suscripción",
            type: "success",
          });
        },
      });
