    ...
    <Modal :maxWidth="'7xl'" :show="showProjectInfoModal" @close="showProjectInfoModal = false">
        <main class="relative bg-black text-white">
            ...
            <body class="lg:py-5 lg:px-12 p-4">
                ...
                <!-- imagenes -->
                <section>
                    <el-carousel :interval="300000" type="card" :height="carouselHeight">
            ...
            <div class="flex items-center justify-end space-x-5 bg-gray- p-3">
                ...
                <a v-if="selectedProject.canVisitSite" :href="selectedProject.url" target="_blank"
                    class="inline-flex items-center px-4 py-2 bg-primary border border-transparent rounded-full text-xs text-white tracking-widest active:bg-primarydark transition-all ease-in-out duration-100 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed">Visitar
                    sitio</a>
            </div>
        </main>
    </Modal>
        ...
        return {
            ...
            projects: [
                ...
                },
                {
                    ...
                    images: [Emblems3dUSA, Emblems3dUSA1, Emblems3dUSA01, Emblems3dUSA02],
                    canVisitSite: false
                },
                {
