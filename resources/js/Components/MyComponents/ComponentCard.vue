    ...
    <div class="bg-gray-200 rounded-2xl shadow-lg p-5 border border-gray-200 transition hover:shadow-2xl self-start">
        ...
        <div class="flex items-center justify-between mx-2">
            ...
            <div class="flex items-center space-x-2">
                <i class="fa-brands fa-html5 text-orange-500 text-2xl"></i>
                <i v-if="component.css_code" class="fa-brands fa-css3-alt text-blue-600 text-2xl"></i>
                <i v-if="component.js_code" class="fa-brands fa-square-js text-yellow-400 text-2xl"></i>
        ...
        <div :id="`component-${component.id}`" class="border h-52 border-gray-400/50 rounded-lg overflow-hidden p-4 flex items-center justify-center" :class="'bg-['+ component.bg_color + ']'">
