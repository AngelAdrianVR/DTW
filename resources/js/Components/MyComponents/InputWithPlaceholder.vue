<template>
    <div class="lg:w-full">
        <div class="input-container">
            <label class="input-placeholder text-[#9a9a9a] bg-white px-2 rounded-sm text-xs"
                :class="{ 'active': isFocused || modelValue }">
                <slot />
            </label>
            <input :value="modelValue" :step="inputStep" :type="inputType" @focus="isFocused = true"
                @blur="isFocused = false" @input="updateModelValue" 
